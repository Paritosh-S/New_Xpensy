...
if(isset($_POST['UName']) && isset($_POST['forgot']))
{
	$NewPass = $_POST['UName'];
...
<center><p><a>Enter Email address</a></p>
                ...
                <div class="input-group input-group-md">
                    ...
                    <div class="icon-addon addon-md">
                      <input name="UName" required class="form-control" id="login-username" type="email" placeholder="Enter you Email address" onfocus="this.value=''">
                    </div>
