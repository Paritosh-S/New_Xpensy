...
?>
 ...
 <div class="box box-primary ">
                <!--<div class="box-header">
                  <h3 class="box-title">Expense Report as PDF</h3>
<div class="pull-right"><form name="delrpt" method="post" action="">
					 <input type="submit" class="btn btn-danger " name="btndel" value="Delete all reports" onclick="return confirm('Are you sure you want to delete all records?');">
					 </form></div>
                </div><!-- /.box-header -->

                <div class="box-body">
<div class="pull-center"><form name="delrpt" method="post" action="">
					 <input type="submit" class="btn btn-danger " name="btndel" value="Delete all reports" onclick="return confirm('Are you sure you want to delete all records?');">
					 </form></div>
                  <table id="example2" class="table table-bordered table-striped table-hover table-responsive">
                    <thead>
                      <tr>
                        ...
                        <th style=" text-align:center;">Download/ Delete</th>
...
<a  href="#" data-toggle="modal"  data-target="#myModal_editSavedReports">Email</a>/-->
				 <a  data-toggle="tooltip" title="Download PDF" href="PDFDOCS/<?php echo $row[0].".pdf";?>"  target="_blank"><i class="fa fa-Download fa-lg"></i></a>&nbsp;&nbsp;
                       <a  data-toggle="tooltip" title="Delete PDF" href="ViewReports.php?&DelPDF=<?php $r = md5(rand()); echo $row[2]."&key=".$r."&f=".$row[2];?>" onclick="return confirm('Are you sure you want to delete ?')" ><i class="fa fa-trash fa-lg" ></i></a></td></tr>
<?php
}
}
$dbh->Connection = Null;
