...
.help-block {
  ...
  <body ng-app="app" ng-controller="AppCtrl" class="hold-transition skin-blue sidebar-mini" style="font-family:Segoe UI;font-size:12;">
  <?php 
try
{
include('dbcon.php');
...
<div class="col-md-6 col-md-offset-3">
				   ...
				   <div class="form-group">
                    ...
                    <div class="panel box box-success">
                      ...
                      <div id="collapseTwo" class="panel-collapse collapse">
                        <div class="box-body">
 <form role="form" method="POST" action="" name="myForm" class="form" novalidate>
 
 <div class="form-group" ng-class="{'has-error':!myForm.currentPassword.$valid}">
        <label for="currentPassword">Current Password</label>
        <input class="form-control" type="text" name="currentPassword" placeholder="currentPassword..." required ng-model="currentPassword" />
        <span class="help-block" ng-show="myForm.currentPassword.$error.required">Required</span>
      </div>
 ...
 <div class="form-group" ng-class="{'has-error':!myForm.password.$valid}">
	...
	<input type="submit" onclick="autoRefresh()" name="UpdatePass"  value="Update" class="btn btn-success" ng-disabled="myForm.$invalid"> 
