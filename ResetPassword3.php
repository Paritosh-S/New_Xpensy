...
<div class="form-group">						
                <div class="input-group input-group-md">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                    <div class="icon-addon addon-md">
<input type="password" required class="input password" Placeholder="Confirm password" onfocus="this.value=''" name="RePassword" style="width:100%;"/><br>
</div>
    </div>
            </div>
<!--END PASSWORD-->
...
<div class="footer">
                       ...
                       <center><button type="submit" class="btn" name="reset" value="Reset Password" class="btn" style="color:white;">Reset</button></center>
