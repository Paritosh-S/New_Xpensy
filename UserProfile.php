 ...
 <div class="form-group">
			 ...
			 <div class="col-md-7">
              <div class="box">
				...
				<div class="row">
				<div class="col-md-12" >
                                   <form method="GET" action="Get PDF Download.php" >
<br>
                                     <div class="col-md-1" >
				        <h4><a title="Show All Expense" href="UserProfile.php">&nbsp;<span class='glyphicon  glyphicon-triangle-bottom'></span></a></h4>
                                     </div>
                                     <div class="col-md-5" >
...
<button type="button" class="btn btn-default btn-md" data-toggle="modal" data-target="#myModal">Save Report</button>
                                      ...
                                      <div class="row">
                                      <div class="col-md-12" >
                                        <center><p id="show_status" style="display:none;"></p></center>
                                     </div>
...
if (isset($_POST['Add'])) 
{
		if (isset($_FILES['ClaimReceipt']))
		{
			...
			$file_name = $ExCategory."_".$Curr."_".$_REQUEST['ClaimAmt']."_ID".$varCount.".".$f_type;			
...
<tr class=m>
										<form action="" method="POST" name="Update" role="form" enctype="multipart/form-data">
												...
												<td title="Sort by Category">
													<a size="9" href=UserProfile.php?&C=<?php echo $row1[0];?>><strong><?php echo $row1[0]; ?></strong></a>
												</td>
												...
												//<center><a href="" data-toggle="modal" data-target=".bs-example-modal-lg"><img src=images/Attach-icon.png width="25px" height="22px" ></a></center>
																		...
																		$idddd=$row1[4];
													 echo "<center><a href='' data-toggle='modal' role='button' data-target='#exceed$idddd' data-toggle='tooltip' data-placement='right' title='View Receipt' ><img src=images/Attach-icon.png width=15px height=12px /></a></center>";
												 echo"  <div id='modals'>
 ...
 <input type='hidden' name='hiddenimage11' value='$row1[5]'> 
	   <input type='hidden' name='hiddenidrs11' value='$idddd'> 
         ...
         <a href='UserProfile.php?removiimg=$idddd' class='btn btn-danger' >Remove</a>
													...
													$idempty=$row1[4];
													 echo "<center><a href='popupfile.php?idd=$idempty' style='color:black;text-decoration:none;' data-toggle='tooltip' data-placement='right' title='Add Receipt'><span class='glyphicon glyphicon-plus-sign'></span></a></center>";
												...
												<td>
												<a href="UserProfile.php?&Delete=<?php echo $row1[4];?>" onclick="return confirm('Do you want to delete this record??')" data-toggle="tooltip" data-placement="right" title="Delete this expense"><span class="glyphicon glyphicon-trash"></span></a>
												<input type=hidden value="<?php echo $row1[4]; ?>" name="Update">
												&nbsp;<input type=submit  value=" " class="btn" id="ibutton" data-toggle="tooltip" data-placement="right" title="Save Changes">
												</td>
<!-- Modal -->
									...
									<tr >
										<form action="" method="POST" name="Update" role="form" enctype="multipart/form-data">
												...
												//<center><a href="" data-toggle="modal" data-target=".bs-example-modal-lg"><img src=images/Attach-icon.png width="25px" height="22px" ></a></center>
																		...
																		$iddddd=$row[4];
													 echo "<center><a href='' data-toggle='modal' role='button'  data-target='#exceed$iddddd' data-toggle='tooltip' data-placement='right' title='View Receipt'><img src=images/Attach-icon.png width=15px height=12px /></a></center>";
												 echo"  <div id='modals'>
...
<br />
 ...
 <input type='hidden' name='hiddenimage' value='$row[5]'> 
	...
	$idempty=$row[4];
	 ...
	 echo "<center><a href='popupfile.php?idd=$idempty' style='color:black;text-decoration:none;'data-toggle='tooltip' data-placement='right' title='Add Receipt'><span class='glyphicon glyphicon-plus-sign'></a></center>";
...
?>
												...
												<td >
												<a  href="UserProfile.php?&Delete=<?php echo $row[4];?>" onclick="return confirm('Do you want to delete this record?')" data-toggle="tooltip" data-placement="right" title="Delete this expense"> <span class="glyphicon glyphicon-trash"></span> </a>
...
<br>                       
                                        <input type="text" maxlength="30" name="Title1" id="t2" class="form-control" placeholder="Write the title here">				 
                                   
                                        <center><p id="show_status1" style="display:none;"></p></center>	
 
        </div>
        <div class="modal-footer">
  <input type="button" name="set_title" value="Generate PDF Receipt" class="btn btn-success" id="btn2" onClick="CreateReport(Title1.value,this.id)">
...
<script>
function CreateReport(text, btnId)
{
	if (text != "")
	{
		...
		xhr.onreadystatechange = function () 
		{
			if (xhr.readyState == 4 && xhr.status == 200) 
			{
				...
				{
                                        document.getElementById('t2').value = "";
					document.getElementById("show_status1").innerHTML = xhr.responseText;
					setTimeout(function () {
						document.getElementById('show_status1').style.display = 'block';
						setTimeout(function () {
							$('#show_status1').show();
		...
		if (btnId != 'btn2') 
		{
			xhr.open("POST", "Get PDF Download.php", true);
			xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8");
			xhr.send("Title=" + text);
		}
		else
		{
			xhr.open("POST", "GetReceiptsDownloads.php", true);
			xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8");
			xhr.send("Title=" + text);
		}
	}
	else
	{
		if (btnId != 'btn1') 
		{
			document.getElementById("show_status1").innerHTML = "Enter title to create report";
			document.getElementById("show_status1").style.display = 'block';
		} 
		else 
		{
			document.getElementById("show_status").innerHTML = "Enter title to create report";
			document.getElementById("show_status").style.display = 'block';
		}
	}
}
